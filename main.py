...
pf22=pd.read_csv(r'Proyecto_individual_1\dataset\get_actor.csv')
pf_titulo=pd.read_csv(r'Proyecto_individual_1\dataset\score_titulo.csv')
pf_votos_titulo=pd.read_csv(r'Proyecto_individual_1\dataset\votos_titulo.csv')
pf_date=pd.read_csv(r'Proyecto_individual_1\dataset\cantidad_filmaciones_dia.csv')
pf_director=pd.read_csv(r'Proyecto_individual_1\dataset\get_director.csv')
movies=pd.read_csv(r'Proyecto_individual_1\dataset\movies1.csv')
...
def predict_score(titulo_film:str):  
  ...
  for neighbor in neighbors:
    ...
    #print('predict rating %s es: %f' %(new_movie['title'].values[0],avgRating))
    #print('el rating actual %s es  %f' %(new_movie['title'].values[0],new_movie['vote_average'])) 
